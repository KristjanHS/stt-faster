...
REM     to one knob.
REM   - DIARIZE (raw caller knob) is folded into STT_DIARIZE_ON by
REM     _runtime.bat; _docker_run.bat reads that to mount the speaker model.
...
REM     HF_TOKEN / HF_XET_HIGH_PERFORMANCE via -e flags and mounts the WSL models.
