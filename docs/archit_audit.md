...
1. **No real service boundaries (high-level code depends on low-level details)**
...
If you want, I can turn these into a **sequenced fix plan** (3–5 milestones) that minimizes risk and keeps your pipeline working after each step.
