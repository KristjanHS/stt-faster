...
**Status:** in progress — slice 1 shipped (`e59ac04`, `0653df2`); slice 2 shipped (`0895ab9`, `4799a25`); slice 3 shipped (`bd70690`, `830674e`); slice 4 `make release` shipped (`9aef2a4`, `7a4884c`), `build_installer.bat` owed by the owner (Claude cannot write `.bat`); next: slice 5. Execute slice by slice (`/qimpag` per slice).
