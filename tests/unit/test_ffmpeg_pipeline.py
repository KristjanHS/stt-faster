...
def mock_ffmpeg() -> MagicMock:
    """Stand-in for the ffmpeg-python module, injected via ``ffmpeg_module=``."""
    return MagicMock()


def test_arnndn_filter_included(tmp_path: Path, default_rnnoise_mix: float, mock_ffmpeg: MagicMock) -> None:
...
def test_filter_graph_includes_all_filters(tmp_path: Path, default_rnnoise_mix: float, mock_ffmpeg: MagicMock) -> None:
...
def test_loudnorm_preset_selection(tmp_path: Path, default_rnnoise_mix: float, mock_ffmpeg: MagicMock) -> None:
...
def test_default_rnnoise_model_uses_sh_rnnn(tmp_path: Path, default_rnnoise_mix: float, mock_ffmpeg: MagicMock) -> None:
...
def test_filter_order_3_phase_preprocessing(tmp_path: Path, default_rnnoise_mix: float, mock_ffmpeg: MagicMock) -> None:
